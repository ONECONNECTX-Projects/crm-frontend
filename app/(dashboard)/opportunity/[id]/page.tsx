      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
        ...
        <div className="w-full lg:w-1/4 bg-white rounded-xl p-4 sm:p-5 shadow-sm h-fit">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-3 font-semibold text-sm sm:text-base">{opportunity.name}</h2>
          ...
          <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-xs sm:text-sm">
            <div>
              ...
              <p className="truncate">{opportunity.owner?.name || "-"}</p>
            </div>
            <div>
              <p className="text-gray-400">Company</p>
              <p className="truncate">{opportunity.company?.name || "-"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="truncate">{opportunity.type?.name || "-"}</p>
            </div>
          </div>
