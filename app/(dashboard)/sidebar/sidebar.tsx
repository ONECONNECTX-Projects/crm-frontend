...
export default function Sidebar({ collapsed, onNavigate }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* STATIC HEADER */}
      {/*
       * 504x105 wordmark (4.8:1). Expanded: contain it inside the 56px bar,
       * which has to stay 56px to line up with the page header. Collapsed:
       * crop to the leftmost square, which is the X mark on its own.
       */}
      <div
      ...
      >
        <img
          ...
          className={
            collapsed
              ? "size-9 max-w-none object-cover object-left"
              : "max-h-9 max-w-40 object-contain"
          }
        />
      </div>
